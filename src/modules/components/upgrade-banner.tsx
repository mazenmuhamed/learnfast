...
export function UpgradeBanner() {
  ...
  return (
    <div className="bg-secondary dark:bg-popover dark:text-popover-foreground text-secondary-foreground sticky inset-x-0 top-14 z-50 px-4 py-3 max-[780]:hidden">
