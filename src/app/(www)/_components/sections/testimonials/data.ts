...
export const testimonial: Testimonial[] = [
  ...
  },
  {
    ...
    hasRating: true,
    content:
      "Wonderful UX learning platform! The courses are very well structured. Information is well explained and condense, you don't need to spend a lot of time trying to understand a topic. Good job!",
  },
  {
    badge: '150% salary increase',
    name: 'Elene Chekurishvili',
    title: 'UX Designer',
    hasRating: true,
    content:
...

  {
    ...
    hasRating: true,
    content:
      "The best online learning platform. I was amazed when I used this platform for the first time. The traditional e-learning platforms are tedious and boring with too much redundant information. This platform is fun, direct to the point, and full of benefits that I couldn't mention all of them.",
  },
  {
    badge: 'landed a new role',
    name: 'Erianna Milia',
